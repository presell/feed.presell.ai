...
import NavArticle1 from "../../NavArticle1"; // plasmic-import: lRoBU_AVXI/component
import BodyArticle1 from "../../BodyArticle1"; // plasmic-import: dAAdljOIrTq/component
  ...
  return (
    <React.Fragment>
      ...
      <style>{`
       ...
       .PlasmicArticleInfo_bodyArticle1__gruVP.__wab_instance{
            margin:50px auto;
                padding: 15px;
          }
          @media screen and (max-width:1020px){
            .PlasmicBodyArticle1_article1Body__70B4p{
              width:95% !important;
          ...
          @media screen and (max-width:767px){
            ...
            .PlasmicNavArticle1_img__SsQks {
              width: 100%;
            }
            .PlasmicNavArticle1_column__ujnQu__vpHsq{
