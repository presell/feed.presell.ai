...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: GnR90DiK5J/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__sTbcs)} />
            ) : null}

            <div className={classNames(projectcss.all, sty.column__hfMig)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__o64Ry)} />
            ) : null}
          </div>
        ) : null}
      </div>
