...
import sty from "./PlasmicNavArticle1.module.css"; // plasmic-import: lRoBU_AVXI/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__sSfyi)}>
                <div
            ...
            <div className={classNames(projectcss.all, sty.column__ujnQu)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__vv0Hq)}>
                <p.PlasmicLink
                  className={classNames(
                    projectcss.all,
                    projectcss.a,
