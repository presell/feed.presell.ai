          ...
          >
            ...
            {true ? (
              <DataFetcher
                ...
                noLayout={false}
                url={
                  '"https://api.airtable.com/v0/appmM1mMqcDvugXhY/PlasmicCMS?filterByFormula=slug="+"\'"+$ctx.params.slug+"\'"' as const
                }
              />
            ) : null}
          </div>
...
const PlasmicDescendants = {
  ...
  freeBox: ["freeBox", "navLogoOnly", "calendarEmbed", "httpApiFetcher"],
