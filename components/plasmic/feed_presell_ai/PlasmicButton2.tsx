...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: 9VYjHrft0vJj/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: 2YrpjGNjOnmx/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__z6I7D)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__f1L1T)}
                role={"img"}
              />
            ),
